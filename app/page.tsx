...
export default function HomePage() {
  ...
  // Закрытые данные администратора (на экране не отображаются)
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    // Проверка входа как руководителя
  ...
  return (
    <div className="space-y-10 py-6">
      ...
      <div className="max-w-md mx-auto p-6 sm:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/90 shadow-2xl space-y-6">
        {/* Переключатель: только 2 вкладки для учениц */}
        {mode !== 'admin' ? (
          ...
          <div className="text-center space-y-1 pb-1">
            ...
            <p className="text-[11px] text-neutral-400">Только для Линда Азизян (авторизация с правами администратора)</p>
          </div>
        )}
        ...
        {/* Скрытая ссылка для входа руководителя */}
