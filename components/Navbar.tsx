    ...
    <header className="sticky top-0 z-40 w-full border-b border-neutral-800 bg-neutral-950/90 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-2 sm:gap-3 text-xs">
            ...
            <Link
              ...
              className={`py-1.5 px-3 rounded-xl flex items-center gap-1.5 font-bold transition-colors border ${
                pathname.startsWith('/admin')
                  ...
                  : 'text-neutral-300 hover:text-white bg-neutral-900/60 border-neutral-800 hover:border-neutral-700'
              }`}
            >
          ...
          {/* Отображается для авторизованной ученицы */}
            ...
            <>
              {profile || isAdmin ? (
                <button
                  ...
                  className="py-1.5 px-3 rounded-xl text-neutral-400 hover:text-red-400 bg-neutral-900/60 border border-neutral-800 hover:border-red-900/50 flex items-center gap-1 cursor-pointer transition-colors"
